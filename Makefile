...
gpu: libwarp.so
	$(NVCC) -m64 $(OPTIX_FLAGS) $(CUDPP_FLAGS) $(PYTHON_FLAGS)  -L/home/krowland/warp-1 -lwarp main.cpp -o $@

optixtest: libwarp.so
	$(NVCC) -m64 $(OPTIX_FLAGS) $(CUDPP_FLAGS) $(PYTHON_FLAGS)  -L/home/krowland/warp-1 -lwarp -loptix optixtest.cpp -o $@
