...
//	}
	...
	if (!isfinite(sampled_E) | sampled_E < 0.0){
		printf("continuum scatter mis-sampled tid %i data_dex %u E0 %6.4E sampled_E %6.4E dist len %u dist_index %u... \n",tid_in,tid,E0,sampled_E,this_sdist.len,dist_index[0]);
	}
